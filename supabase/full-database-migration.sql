...
create table if not exists public.invoices (
  ...
  payment_method text not null default 'Cash' check (payment_method in ('Cash', 'UPI', 'Card', 'Bank Transfer', 'Cash + UPI')),
  transaction_id text,
  notes text,
  staff_name text,
...
create table if not exists public.transactions (
  ...
  customer_id uuid references public.customers(id) on delete set null,
  payment_method text not null check (payment_method in ('Cash', 'UPI', 'Card', 'Bank Transfer', 'Cash + UPI')),
  transaction_id text,
