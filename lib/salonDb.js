...
export async function updateCategory(id, data) {
  const { data: row, error } = await table("categories").update(data).eq("id", id).select().single();
  if (error) throw error;
  return row;
}
...
export async function updateOffer(id, data) {
  const { data: row, error } = await table("offers").update(data).eq("id", id).select().single();
  if (error) throw error;
  return row;
}
...
export async function updateGalleryItem(id, data) {
  const { data: row, error } = await table("gallery").update(data).eq("id", id).select().single();
  if (error) throw error;
  return row;
}
